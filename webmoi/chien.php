...
<?php include 'includes/Header.php'; ?>
                     ...
                     <div class="swiper-slide hero-slide" style="background-image: url('images/sliders/slider_4.png');">
                         <div class="container">
                             <div class="hero-content">
                                 <h2>Siêu Sale</h2>
                                 <p>Giảm giá chớp nhoáng - Mua ngay kẻo lỡ!</p>
    ...
    <section class="products-section" style="background: var(--light-color);">
        <div class="container featured-slider-container"> <h2 class="section-title">Sản phẩm nổi bật</h2>
            ...
            <?php if ($featured_products && $featured_products->num_rows > 0): ?>
                <div class="product-slider-horizontal"> <?php while ($product = $featured_products->fetch_assoc()): ?>
                        <div class="product-card featured-product-card"> <?php if ($product['stock'] < 10 && $product['stock'] > 0): ?>
